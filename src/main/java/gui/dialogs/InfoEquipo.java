...
public class InfoEquipo extends javax.swing.JDialog {
    ...
    public InfoEquipo(int idEquipo) {
        ...
        Imagenes.setImagenBoton(jButton_GenerarTicket, "images/impresora.png", true);
    ...
    private void initComponents() {
        ...
        jButton_GenerarTicket = new javax.swing.JButton();
        ...
        jButton_GenerarTicket.setBackground(new java.awt.Color(1, 89, 255));
        jButton_GenerarTicket.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jButton_GenerarTicket.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_GenerarTicketActionPerformed(evt);
            }
        });
        getContentPane().add(jButton_GenerarTicket, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 460, 60, 50));
    ...
    private void jButton_GenerarTicketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GenerarTicketActionPerformed
        ordenServicio = new TicketRecepcion(Consultar.ConsultarInfoEmpresa());
        ...
        ordenServicio.setContactoCliente(infoCliente[1]);
        ordenServicio.setNumeroSerie(infoEquipo[3]);
        ordenServicio.setTipoEquipo(infoEquipo[0]);
        ordenServicio.setMarca(infoEquipo[1]);
        ordenServicio.setModelo(infoEquipo[2]);
        ordenServicio.setObservaciones(infoEquipo[6]);
        ordenServicio.setVendedor(infoEquipo[10]);
    ...
    private void initTextField() {
        txt_NombreCliente.setText(Consultar.ConsultarNombreCliente(Consultar.ConsultarIdCliente(idEquipo)));
    ...
    private javax.swing.JButton jButton_GenerarTicket;
