...
public class Administrador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Titulo1.setFont(new java.awt.Font("Arial", 0, 28)); // NOI18N
        ...
        jPanel_RegistrarUsuarios.add(jLabel_Titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1, 10, 740, 40));

        jLabel2.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Nombre:");
        jPanel_RegistrarUsuarios.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 70, -1, -1));
        ...
        jPanel_RegistrarUsuarios.add(txt_Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 210, -1));

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("eMail:");
        jPanel_RegistrarUsuarios.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, -1, -1));
        ...
        jPanel_RegistrarUsuarios.add(txt_Mail, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 150, 210, -1));

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Telefono:");
        jPanel_RegistrarUsuarios.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 190, -1, -1));
        ...
        jPanel_RegistrarUsuarios.add(txt_Telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 210, 210, -1));

        cmb_Permisos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "Capturista", "Tecnico" }));
        jPanel_RegistrarUsuarios.add(cmb_Permisos, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 270, -1, -1));

        jLabel5.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Permisos de:");
        jPanel_RegistrarUsuarios.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, -1, -1));
        ...
        jPanel_RegistrarUsuarios.add(txt_Usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, 210, -1));

        jLabel6.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Usuario:");
        jPanel_RegistrarUsuarios.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 70, -1, -1));

        jLabel7.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Password:");
        jPanel_RegistrarUsuarios.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 130, -1, -1));
        ...
        jPanel_RegistrarUsuarios.add(txt_Password, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 150, 210, -1));
        ...
        jPanel_RegistrarUsuarios.add(jButton_RegistrarUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 260, 120, 100));
        ...
        modelUsuarios.setColumnCount(0);
        tablaUsuarios = new JTable(modelUsuarios);
        scrollUsuarios.setViewportView(tablaUsuarios);
        String Q_Usuarios = "select id_usuario, nombre_usuario, username, tipo_nivel, estatus from usuarios";
        String[] T_Usuarios = {"ID", "Nombre", "usuario", "Permisos", "Estatus"};
        buildTabla.buildTablaUsuarios(modelUsuarios, tablaUsuarios, scrollUsuarios, Q_Usuarios, 5, T_Usuarios);

        jPanel_GestionarUsuarios.add(scrollUsuarios, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 715, 360));

        jLabel_Titulo.setFont(new java.awt.Font("Arial", 0, 28)); // NOI18N
        jLabel_Titulo.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_Titulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel_Titulo.setText("Usuarios registrados");
        jPanel_GestionarUsuarios.add(jLabel_Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 740, 40));
        ...
        txt_CondicionesEmpresa.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
    ...
    private void jButton_RegistrarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistrarUsuarioActionPerformed
        ...
        if (nombre.equals("") || mail.equals("") || telefono.equals("")
            ...
            JOptionPane.showMessageDialog(null, "Para continuar deberá llenar todos los campos");

        } else {

            if (Consultar.ConsultarUsuario(usuario)) {

                JOptionPane.showMessageDialog(null, "El Usuario no esta disponible, intenete nuevamente");

            } else {

                Registrar.RegistrarUsuario(new String[]{nombre, mail, telefono, usuario, pass, permisos});
    ...
    private void jButton_ActualizarInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarInfoActionPerformed
        ...
        Actualizar.ActualizarInfoEmpresa(new String[]{empresa, propietario, rfc, direccion, telefono, condiciones});
    ...
    private void initFondos() {
        ...
        Imagenes.setImagenFondo(jLabel_FondoUsuarios);
        Imagenes.setImagenFondo(jLabel_FondoRegistrarUsuario);
        Imagenes.setImagenFondo(jLabel_FondoGestionarUsuarios);
        ...
        Imagenes.setImagenFondo(jLabel_FondoUtilidades);
        Imagenes.setImagenFondo(jLabel_FondoTicket);
    }

    private void initBotones() {
        Imagenes.setImagenBoton(jButton_RegistrarUsuario, "images/add.png", false);
    ...
    private void initUtilidades() {
        String[] infoEmpresa = Consultar.ConsultarInfoEmpresa();
